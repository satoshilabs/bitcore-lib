 ...
 * var error = Address.getValidationError(input, Constants.TESTNET);
 * if (!error) {
 *   var address = Address(input, Constants.TESTNET);
 * } else {
 ...
 * var address = Address(publicKey, Constants.TESTNET).toString();
 * ```
 *
 ...
 * var error = Address.getValidationError('15vkcKf7gB23wLAnZLmbVuMiiVDc1Nm4a2', Constants.TESTNET);
 * ```
 *
