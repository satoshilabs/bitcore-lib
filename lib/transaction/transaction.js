 ...
 * and a slightly fancier format recognized by btcLib:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a btcLib Address object. The
 * same is true for `script`, which can be a string or a btcLib Script.
 *
