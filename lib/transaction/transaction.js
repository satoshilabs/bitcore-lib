 ...
 * and a slightly fancier format recognized by ows:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a ows Address object. The
 * same is true for `script`, which can be a string or a ows Script.
 *
